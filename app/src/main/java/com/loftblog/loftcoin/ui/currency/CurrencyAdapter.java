...
import com.loftblog.loftcoin.data.Currency;
import com.loftblog.loftcoin.databinding.LiCurrencyBinding;
...
public class CurrencyAdapter extends ListAdapter<Currency, CurrencyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.name.setText(String.format("%s | %s", currency.name(), currency.code()));
